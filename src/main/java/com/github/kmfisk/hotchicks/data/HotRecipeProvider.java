...
public class HotRecipeProvider extends RecipeProvider {
    ...
    protected void buildShapelessRecipes(Consumer<IFinishedRecipe> consumer) {
        ...
        namedShapelessRecipeResult(consumer, "beef_steak_0", Items.ROTTEN_FLESH, 2, ImmutableList.of(Ingredient.of(HotItems.POOR_BEEF_PRIMAL.get())));
        namedShapelessRecipeResult(consumer, "beef_steak_1", HotItems.BEEF_STEAK.get(), 1, ImmutableList.of(Ingredient.of(HotItems.FAIR_BEEF_PRIMAL.get())));
        namedShapelessRecipeResult(consumer, "beef_steak_2", HotItems.BEEF_STEAK.get(), 2, ImmutableList.of(Ingredient.of(HotItems.GOOD_BEEF_PRIMAL.get())));
        namedShapelessRecipeResult(consumer, "beef_steak_3", HotItems.BEEF_STEAK.get(), 3, ImmutableList.of(Ingredient.of(HotItems.CHOICE_BEEF_PRIMAL.get())));
        namedShapelessRecipeResult(consumer, "beef_steak_4", HotItems.BEEF_STEAK.get(), 4, ImmutableList.of(Ingredient.of(HotItems.PRIME_BEEF_PRIMAL.get())));
        ...
        shapelessRecipeResult(consumer, HotItems.PICKLES.get(), 3, ImmutableList.of(Ingredient.of(HotItems.CUCUMBER.get()), Ingredient.of(HotItems.CUCUMBER.get()), Ingredient.of(Tags.Items.SEEDS), Ingredient.of(HotItems.GARLIC.get())));
        ...
        shapelessRecipeResult(consumer, HotItems.BEEF_CHILI_SOUP.get(), 4, ImmutableList.of(Ingredient.of(Items.WATER_BUCKET), Ingredient.of(HotItemTags.RAW_BEEFS), Ingredient.of(HotItemTags.RAW_BEEFS), Ingredient.of(HotItems.GARLIC.get()), Ingredient.of(HotItems.PEPPERS.get()), Ingredient.of(HotItems.TOMATO.get())));
        shapelessRecipeResult(consumer, HotItems.BEEF_STROGANOFF_SOUP.get(), 4, ImmutableList.of(Ingredient.of(Items.WATER_BUCKET), Ingredient.of(HotItemTags.RAW_BEEFS), Ingredient.of(HotItemTags.RAW_BEEFS), Ingredient.of(HotItemTags.MILKS), Ingredient.of(Tags.Items.MUSHROOMS), Ingredient.of(Tags.Items.MUSHROOMS), Ingredient.of(HotItems.GARLIC.get()), Ingredient.of(HotItems.BUTTER.get())));
        shapelessRecipeResult(consumer, HotItems.BRAISED_RABBIT_SOUP.get(), 4, ImmutableList.of(Ingredient.of(Items.WATER_BUCKET), Ingredient.of(HotItemTags.RAW_RABBITS), Ingredient.of(Items.CARROT), Ingredient.of(Tags.Items.MUSHROOMS), Ingredient.of(HotItems.PEPPERS.get()), Ingredient.of(HotItemTags.MILKS)));
