...
public class HotItems {
    ...
    public static final RegistryObject<Item> CITRUS_COOLER = REGISTRAR.register("citrus_cooler", () -> new DrinkItem(new Item.Properties().tab(HotChicks.HOT_CHICKS_GROUP).food(HotFoods.CITRUS_COOLER)));
    public static final RegistryObject<Item> BERRY_PROTEIN_SHAKE = REGISTRAR.register("berry_protein_shake", () -> new DrinkItem(new Item.Properties().tab(HotChicks.HOT_CHICKS_GROUP).food(HotFoods.BERRY_PROTEIN_SHAKE)));
    public static final RegistryObject<Item> CHOCOLATE_PROTEIN_SHAKE = REGISTRAR.register("chocolate_protein_shake", () -> new DrinkItem(new Item.Properties().tab(HotChicks.HOT_CHICKS_GROUP).food(HotFoods.CHOCOLATE_PROTEIN_SHAKE)));
    public static final RegistryObject<Item> CREAMSICLE_PROTEIN_SHAKE = REGISTRAR.register("creamsicle_protein_shake", () -> new DrinkItem(new Item.Properties().tab(HotChicks.HOT_CHICKS_GROUP).food(HotFoods.CREAMSICLE_PROTEIN_SHAKE)));
    public static final RegistryObject<Item> KEY_LIME_PROTEIN_SHAKE = REGISTRAR.register("key_lime_protein_shake", () -> new DrinkItem(new Item.Properties().tab(HotChicks.HOT_CHICKS_GROUP).food(HotFoods.KEY_LIME_PROTEIN_SHAKE)));
    public static final RegistryObject<Item> PEACH_MANGO_PROTEIN_SHAKE = REGISTRAR.register("peach_mango_protein_shake", () -> new DrinkItem(new Item.Properties().tab(HotChicks.HOT_CHICKS_GROUP).food(HotFoods.PEACH_MANGO_PROTEIN_SHAKE)));
    public static final RegistryObject<Item> SUPERFOOD_PROTEIN_SHAKE = REGISTRAR.register("superfood_protein_shake", () -> new DrinkItem(new Item.Properties().tab(HotChicks.HOT_CHICKS_GROUP).food(HotFoods.SUPERFOOD_PROTEIN_SHAKE)));
    public static final RegistryObject<Item> TROPICAL_PROTEIN_SHAKE = REGISTRAR.register("tropical_protein_shake", () -> new DrinkItem(new Item.Properties().tab(HotChicks.HOT_CHICKS_GROUP).food(HotFoods.TROPICAL_PROTEIN_SHAKE)));
    public static final RegistryObject<Item> SMOOTHIE = REGISTRAR.register("smoothie", () -> new DrinkItem(new Item.Properties().tab(HotChicks.HOT_CHICKS_GROUP).food(HotFoods.SMOOTHIE)));
    ...
    public static final RegistryObject<Item> FRUIT_BOWL = REGISTRAR.register("fruit_bowl", () -> new SoupItem(new Item.Properties().tab(HotChicks.HOT_CHICKS_GROUP).food(HotFoods.FRUIT_BOWL).craftRemainder(Items.BOWL)));
    ...
    public static final RegistryObject<Item> OATMEAL = REGISTRAR.register("oatmeal", () -> new SoupItem(new Item.Properties().tab(HotChicks.HOT_CHICKS_GROUP).food(HotFoods.OATMEAL).craftRemainder(Items.BOWL)));
    ...
    public static final RegistryObject<Item> CHICKEN_SALAD = REGISTRAR.register("chicken_salad", () -> new SoupItem(new Item.Properties().tab(HotChicks.HOT_CHICKS_GROUP).food(HotFoods.CHICKEN_SALAD).craftRemainder(Items.BOWL)));
    public static final RegistryObject<Item> CHINESE_CHICKEN_SALAD = REGISTRAR.register("chinese_chicken_salad", () -> new SoupItem(new Item.Properties().tab(HotChicks.HOT_CHICKS_GROUP).food(HotFoods.CHINESE_CHICKEN_SALAD).craftRemainder(Items.BOWL)));
    public static final RegistryObject<Item> DANDELION_SALAD = REGISTRAR.register("dandelion_salad", () -> new SoupItem(new Item.Properties().tab(HotChicks.HOT_CHICKS_GROUP).food(HotFoods.DANDELION_SALAD).craftRemainder(Items.BOWL)));
    public static final RegistryObject<Item> GARDEN_SALAD = REGISTRAR.register("garden_salad", () -> new SoupItem(new Item.Properties().tab(HotChicks.HOT_CHICKS_GROUP).food(HotFoods.GARDEN_SALAD).craftRemainder(Items.BOWL)));
    public static final RegistryObject<Item> POWER_SALAD = REGISTRAR.register("power_salad", () -> new SoupItem(new Item.Properties().tab(HotChicks.HOT_CHICKS_GROUP).food(HotFoods.POWER_SALAD).craftRemainder(Items.BOWL)));
