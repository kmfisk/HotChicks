...
public class HotFoods {
    ...
    public static final Food MANGO = (new Food.Builder()).nutrition(5).saturationMod(0.3F).build();
    ...
    public static final Food ORANGE = (new Food.Builder()).nutrition(5).saturationMod(0.3F).build();
