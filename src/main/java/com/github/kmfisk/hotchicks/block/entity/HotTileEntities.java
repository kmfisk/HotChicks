...
public class HotTileEntities {
    ...
    public static RegistryObject<TileEntityType<TroughTileEntity>> TROUGH = REGISTRAR.register("trough", () -> TileEntityType.Builder.of(() -> new TroughTileEntity(false), HotBlocks.TROUGH_BLOCK.get()).build(null));
    public static RegistryObject<TileEntityType<TroughTileEntity>> METAL_TROUGH = REGISTRAR.register("metal_trough", () -> TileEntityType.Builder.of(() -> new TroughTileEntity(true), HotBlocks.METAL_TROUGH_BLOCK.get()).build(null));
}
