...
public class HotTileEntities {
    public static final DeferredRegister<BlockEntityType<?>> REGISTRAR = DeferredRegister.create(ForgeRegistries.BLOCK_ENTITIES, HotChicks.MOD_ID);
    ...
    public static final RegistryObject<BlockEntityType<TroughTileEntity>> TROUGH = REGISTRAR.register("trough", () -> BlockEntityType.Builder.of((pos, state) -> new TroughTileEntity(false, pos, state), HotBlocks.WOODEN_TROUGH.get()).build(null));
    public static final RegistryObject<BlockEntityType<TroughTileEntity>> METAL_TROUGH = REGISTRAR.register("metal_trough", () -> BlockEntityType.Builder.of((pos, state) -> new TroughTileEntity(true, pos, state), HotBlocks.METAL_TROUGH.get()).build(null));
}
