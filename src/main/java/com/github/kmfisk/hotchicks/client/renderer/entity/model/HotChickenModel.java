...
public class HotChickenModel extends ListModel<HotChickenEntity> {
    ...
    public static class RoosterSilkie extends HotChickenModel {
        ...
        public static LayerDefinition createBodyLayer() {
            ...
            partDefinition.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(12, 10).mirror(false).addBox(-1.5F, -1.5F, -1.5F, 3, 3, 3), PartPose.offsetAndRotation(0.0F, -4.0F, 1.6F, -0.045553093477052F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("LegFeathersLeft", CubeListBuilder.create().texOffs(33, 24).mirror(false).addBox(-1.0F, 0.0F, -1.0F, 2, 2, 2), PartPose.offset(0.3F, 0.2F, -0.4F));
            ...
            partDefinition.addOrReplaceChild("Chest", CubeListBuilder.create().texOffs(0, 10).mirror(false).addBox(-1.5F, -3.0F, 0.0F, 3, 3, 3), PartPose.offsetAndRotation(0.0F, 2.1F, -2.5F, 0.7740535232594852F, 0.0F, 0.0F));
            ...
            partDefinition.addOrReplaceChild("Body", CubeListBuilder.create().texOffs(0, 0).mirror(false).addBox(-2.5F, -2.5F, -2.5F, 5, 5, 5), PartPose.offsetAndRotation(0.0F, 18.2F, 0.0F, -0.091106186954104F, 0.0F, 0.0F));
            ...
            partDefinition.addOrReplaceChild("Toe2R", CubeListBuilder.create().texOffs(42, 14).mirror(false).addBox(-0.5F, -1.0F, -2.0F, 1, 1, 2), PartPose.offsetAndRotation(0.0F, 0.0F, 0.2F, 0.045553093477052F, 0.27314402793711257F, 0.0F));
            partDefinition.addOrReplaceChild("Comb", CubeListBuilder.create().texOffs(19, 16).mirror(false).addBox(-0.5F, 0.0F, 0.0F, 1, 2, 2), PartPose.offsetAndRotation(0.0F, -1.5F, -2.2F, 0.22759093446006054F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("Beak", CubeListBuilder.create().texOffs(7, 16).mirror(false).addBox(-0.5F, 0.0F, -2.0F, 1, 1, 2), PartPose.offsetAndRotation(0.0F, 1.0F, 0.4F, -0.31869712141416456F, 0.0F, 0.0F));
            ...
            partDefinition.addOrReplaceChild("Belly", CubeListBuilder.create().texOffs(36, 6).mirror(false).addBox(-2.0F, -2.0F, 0.0F, 4, 3, 3), PartPose.offsetAndRotation(0.0F, 1.5F, -2.0F, -0.36425021489121656F, 0.0F, 0.0F));
            ...
            partDefinition.addOrReplaceChild("Toe2L", CubeListBuilder.create().texOffs(42, 14).mirror(false).addBox(-0.5F, -1.0F, -2.0F, 1, 1, 2), PartPose.offsetAndRotation(0.0F, 0.0F, 0.2F, 0.045553093477052F, 0.27314402793711257F, 0.0F));
            partDefinition.addOrReplaceChild("Tail", CubeListBuilder.create().texOffs(24, 9).mirror(false).addBox(-2.0F, -0.1F, 0.0F, 4, 6, 2), PartPose.offsetAndRotation(0.0F, -2.4F, 1.3F, 0.3361504139341079F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("ThighLeft", CubeListBuilder.create().texOffs(32, 0).mirror(false).addBox(-1.0F, -1.0F, -1.0F, 2, 4, 2), PartPose.offsetAndRotation(1.7F, 1.1F, 0.5F, 0.22759093446006054F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("NeckFeathersLeft", CubeListBuilder.create().texOffs(0, 25).mirror(false).addBox(-1.0F, 0.0F, -3.0F, 2, 3, 3), PartPose.offsetAndRotation(0.4F, -4.1F, 3.0F, 0.31869712141416456F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("LegLeft", CubeListBuilder.create().texOffs(36, 12).mirror(false).addBox(-0.5F, 0.0F, -1.0F, 1, 2, 1), PartPose.offsetAndRotation(-0.4F, 2.5F, 0.5F, -0.36425021489121656F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("HeadPuffLeft", CubeListBuilder.create().texOffs(10, 23).mirror(false).addBox(-1.5F, 0.0F, 0.0F, 3, 2, 3), PartPose.offsetAndRotation(0.2F, -2.5F, -1.3F, -0.2937389131106456F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("TailFeathers", CubeListBuilder.create().texOffs(50, 6).mirror(false).addBox(-1.5F, 0.0F, 0.0F, 3, 5, 4), PartPose.offsetAndRotation(0.0F, 0.0F, 1.3F, -0.27314402793711257F, 0.0F, 0.0F));
            ...
            partDefinition.addOrReplaceChild("BeakBase", CubeListBuilder.create().texOffs(0, 22).mirror(false).addBox(-1.0F, 0.0F, -1.0F, 2, 2, 1), PartPose.offsetAndRotation(0.0F, -0.8F, -1.5F, 0.27314402793711257F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("FootLeft", CubeListBuilder.create().texOffs(41, 13).mirror(false).addBox(-0.5F, -1.0F, -2.0F, 1, 1, 3), PartPose.offsetAndRotation(0.0F, 2.5F, 0.0F, 0.22759093446006054F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("FootRight", CubeListBuilder.create().texOffs(41, 13).mirror(false).addBox(-0.5F, -1.0F, -2.0F, 1, 1, 3), PartPose.offsetAndRotation(0.0F, 2.5F, 0.0F, 0.22759093446006054F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("WingLeft", CubeListBuilder.create().texOffs(25, 17).mirror(false).addBox(0.0F, 0.0F, 0.0F, 1, 3, 4), PartPose.offset(2.0F, -2.1F, -2.0F));
            ...
            partDefinition.addOrReplaceChild("BeardLeft", CubeListBuilder.create().texOffs(22, 24).mirror(false).addBox(-1.5F, 0.0F, 0.0F, 3, 2, 2), PartPose.offset(0.4F, 0.5F, -1.8F));
            partDefinition.addOrReplaceChild("Toe1L", CubeListBuilder.create().texOffs(42, 14).mirror(false).addBox(-0.5F, -1.0F, -2.0F, 1, 1, 2), PartPose.offsetAndRotation(0.0F, 0.0F, 0.2F, 0.045553093477052F, -0.27314402793711257F, 0.0F));
            partDefinition.addOrReplaceChild("BellyRear", CubeListBuilder.create().texOffs(48, 0).mirror(false).addBox(-2.0F, -3.0F, 0.0F, 4, 3, 3), PartPose.offsetAndRotation(0.0F, 1.0F, 3.0F, 0.5009094953223726F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("BeakTop", CubeListBuilder.create().texOffs(13, 16).mirror(false).addBox(-0.5F, 0.0F, 0.0F, 1, 1, 2), PartPose.offsetAndRotation(0.0F, 0.0F, -2.4F, 0.36425021489121656F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("Wattle", CubeListBuilder.create().texOffs(10, 19).mirror(false).addBox(-0.5F, 0.0F, 0.0F, 1, 2, 2), PartPose.offsetAndRotation(0.0F, 1.0F, -0.8F, -0.36425021489121656F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("Neck", CubeListBuilder.create().texOffs(0, 16).mirror(false).addBox(-1.0F, -3.0F, 0.0F, 2, 3, 3), PartPose.offsetAndRotation(0.0F, -3.0F, 0.2F, -0.5009094953223726F, 0.0F, 0.0F));
    ...
    public static class Hen extends HotChickenModel {
        ...
        public static LayerDefinition createBodyLayer() {
            ...
            partDefinition.addOrReplaceChild("Toe2R", CubeListBuilder.create().texOffs(42, 14).addBox(-0.5F, -1.0F, -2.0F, 1.0F, 1.0F, 2.0F), PartPose.offsetAndRotation(0.0F, 0.0F, 0.2F, 0.04555309164612875F, 0.27314402127920984F, 0.0F));
            partDefinition.addOrReplaceChild("Body", CubeListBuilder.create().texOffs(0, 0).mirror(false).addBox(-2.5F, -2.5F, -2.5F, 5.0F, 5.0F, 5.0F), PartPose.offsetAndRotation(0.0F, 17.6F, 0.0F, -0.0911061832922575F, 0.0F, 0.0F));
            ...
            partDefinition.addOrReplaceChild("BeardLeft", CubeListBuilder.create().texOffs(19, 24).mirror(false).addBox(-1.5F, 0.0F, 0.0F, 3.0F, 2.0F, 2.0F), PartPose.offset(0.4F, 0.5F, -1.8F));
            partDefinition.addOrReplaceChild("BellyRear", CubeListBuilder.create().texOffs(48, 0).mirror(false).addBox(-2.0F, -4.0F, 0.0F, 4.0F, 4.0F, 3.0F), PartPose.offsetAndRotation(0.0F, 1.0F, 3.0F, 0.500909508638178F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("Tail", CubeListBuilder.create().texOffs(24, 9).mirror(false).addBox(-1.5F, 0.0F, 0.0F, 3.0F, 5.0F, 2.0F), PartPose.offsetAndRotation(0.0F, -2.5F, 1.0F, 0.4098033003787853F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("ThighLeft", CubeListBuilder.create().texOffs(32, 0).mirror(false).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 4.0F, 2.0F), PartPose.offsetAndRotation(1.7F, 1.1F, 0.5F, 0.2275909337942703F, 0.0F, 0.0F));
            ...
            partDefinition.addOrReplaceChild("LegBand", CubeListBuilder.create().texOffs(0, 2).mirror(false).addBox(-0.5F, 0.0F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.1F, 0.0F, 0.1F)), PartPose.offset(0.0F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("Neck", CubeListBuilder.create().texOffs(0, 16).mirror(false).addBox(-1.0F, -3.0F, 0.0F, 2.0F, 3.0F, 3.0F), PartPose.offsetAndRotation(0.0F, -3.0F, 0.2F, -0.500909508638178F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("Toe1L", CubeListBuilder.create().texOffs(42, 14).mirror(false).addBox(-0.5F, -1.0F, -2.0F, 1.0F, 1.0F, 2.0F), PartPose.offsetAndRotation(0.0F, 0.0F, 0.2F, 0.04555309164612875F, -0.27314402127920984F, 0.0F));
            partDefinition.addOrReplaceChild("Toe2L", CubeListBuilder.create().texOffs(42, 14).mirror(false).addBox(-0.5F, -1.0F, -2.0F, 1.0F, 1.0F, 2.0F), PartPose.offsetAndRotation(0.0F, 0.0F, 0.2F, 0.04555309164612875F, 0.27314402127920984F, 0.0F));
            partDefinition.addOrReplaceChild("Beak", CubeListBuilder.create().texOffs(7, 16).mirror(false).addBox(-0.5F, 0.0F, -2.0F, 1.0F, 1.0F, 2.0F), PartPose.offsetAndRotation(0.0F, 1.0F, 0.4F, -0.3186971254089062F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("Wattle", CubeListBuilder.create().texOffs(10, 19).mirror(false).addBox(-0.5F, 0.0F, 0.0F, 1.0F, 2.0F, 2.0F), PartPose.offsetAndRotation(0.0F, 1.0F, -0.8F, -0.3642502295386026F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("FootLeft", CubeListBuilder.create().texOffs(41, 13).mirror(false).addBox(-0.5F, -1.0F, -2.0F, 1.0F, 1.0F, 3.0F), PartPose.offsetAndRotation(0.0F, 2.5F, 0.0F, 0.2275909337942703F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("BeakTop", CubeListBuilder.create().texOffs(13, 16).mirror(false).addBox(-0.5F, 0.0F, 0.0F, 1.0F, 1.0F, 2.0F), PartPose.offsetAndRotation(0.0F, 0.0F, -2.4F, 0.3642502295386026F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("Chest", CubeListBuilder.create().texOffs(0, 10).mirror(false).addBox(-1.5F, -3.0F, 0.0F, 3.0F, 3.0F, 3.0F), PartPose.offsetAndRotation(0.0F, 2.1F, -2.5F, 0.7740534966278743F, 0.0F, 0.0F));
            ...
            partDefinition.addOrReplaceChild("Belly", CubeListBuilder.create().texOffs(34, 6).mirror(false).addBox(-2.0F, -2.0F, 0.0F, 4.0F, 3.0F, 3.0F), PartPose.offsetAndRotation(0.0F, 1.5F, -2.0F, -0.3642502295386026F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("WingLeft", CubeListBuilder.create().texOffs(25, 16).mirror(false).addBox(0.0F, 0.0F, 0.0F, 1.0F, 3.0F, 4.0F), PartPose.offset(2.0F, -2.1F, -2.0F));
            partDefinition.addOrReplaceChild("FootRight", CubeListBuilder.create().texOffs(41, 13).mirror(false).addBox(-0.5F, -1.0F, -2.0F, 1.0F, 1.0F, 3.0F), PartPose.offsetAndRotation(0.0F, 2.5F, 0.0F, 0.2275909337942703F, 0.0F, 0.0F));
            ...
            partDefinition.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(12, 10).mirror(false).addBox(-1.5F, -1.5F, -1.5F, 3.0F, 3.0F, 3.0F), PartPose.offsetAndRotation(0.0F, -4.0F, 1.6F, -0.0911061832922575F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("Comb", CubeListBuilder.create().texOffs(19, 16).mirror(false).addBox(-0.5F, 0.0F, 0.0F, 1.0F, 2.0F, 2.0F), PartPose.offsetAndRotation(0.0F, -1.5F, -2.0F, 0.2275909337942703F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("BeakBase", CubeListBuilder.create().texOffs(0, 22).mirror(false).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 2.0F, 1.0F), PartPose.offsetAndRotation(0.0F, -0.8F, -1.5F, 0.27314402127920984F, 0.0F, 0.0F));
            ...
            partDefinition.addOrReplaceChild("LegLeft", CubeListBuilder.create().texOffs(34, 12).mirror(false).addBox(-0.5F, 0.0F, -1.0F, 1.0F, 2.0F, 1.0F), PartPose.offsetAndRotation(-0.4F, 3.0F, 0.5F, -0.3642502295386026F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("TailFeathers", CubeListBuilder.create().texOffs(20, 0).mirror(false).addBox(-1.0F, 0.0F, 0.0F, 2.0F, 5.0F, 4.0F), PartPose.offsetAndRotation(0.0F, 0.0F, 0.5F, 0.27314402127920984F, 0.0F, 0.0F));
    ...
    public static class HenSilkie extends HotChickenModel {
        ...
        public static LayerDefinition createBodyLayer() {
            ...
            partDefinition.addOrReplaceChild("LegRight", CubeListBuilder.create().texOffs(36, 12).mirror(true).addBox(-0.5F, 0.0F, -1.0F, 1, 2, 1), PartPose.offsetAndRotation(0.4F, 2.5F, 0.5F, -0.36425021489121656F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("NeckFeathersRight", CubeListBuilder.create().texOffs(0, 25).mirror(true).addBox(-1.0F, 0.0F, -3.0F, 2, 3, 3), PartPose.offsetAndRotation(-0.4F, -4.1F, 3.0F, 0.31869712141416456F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("HeadPuffLeft", CubeListBuilder.create().texOffs(10, 23).mirror(false).addBox(-1.5F, 0.0F, 0.0F, 3, 2, 3), PartPose.offsetAndRotation(0.2F, -2.4F, -1.5F, -0.136659280431156F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("Body", CubeListBuilder.create().texOffs(0, 0).mirror(false).addBox(-2.5F, -2.5F, -2.5F, 5, 5, 5), PartPose.offsetAndRotation(0.0F, 18.2F, 0.0F, -0.091106186954104F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("LegFeathersLeft", CubeListBuilder.create().texOffs(33, 24).mirror(false).addBox(-1.0F, 0.0F, -1.0F, 2, 2, 2), PartPose.offset(0.3F, 0.2F, -0.4F));
            partDefinition.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(12, 10).mirror(false).addBox(-1.5F, -1.5F, -1.5F, 3, 3, 3), PartPose.offsetAndRotation(0.0F, -4.0F, 1.6F, -0.045553093477052F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("TailFeathers", CubeListBuilder.create().texOffs(20, 0).mirror(false).addBox(-1.5F, 0.0F, 0.0F, 3, 5, 3), PartPose.offsetAndRotation(0.0F, 0.0F, 1.3F, -0.091106186954104F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("Belly", CubeListBuilder.create().texOffs(36, 6).mirror(false).addBox(-2.0F, -2.0F, 0.0F, 4, 3, 3), PartPose.offsetAndRotation(0.0F, 1.5F, -2.0F, -0.36425021489121656F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("Comb", CubeListBuilder.create().texOffs(19, 16).mirror(false).addBox(-0.5F, 0.0F, 0.0F, 1, 2, 2), PartPose.offsetAndRotation(0.0F, -1.5F, -2.0F, 0.22759093446006054F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("BellyRear", CubeListBuilder.create().texOffs(48, 0).mirror(false).addBox(-2.0F, -3.0F, 0.0F, 4, 3, 3), PartPose.offsetAndRotation(0.0F, 1.0F, 3.0F, 0.5009094953223726F, 0.0F, 0.0F));
    ...
    public static class Chick extends HotChickenModel {
        ...
        public static LayerDefinition createBodyLayer() {
            ...
            partDefinition.addOrReplaceChild("LegLeft", CubeListBuilder.create().texOffs(9, 7).mirror(false).addBox(-0.5F, -0.8F, -1.0F, 1, 2, 1), PartPose.offsetAndRotation(0.9F, 2.0F, 1.0F, 0.091106186954104F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("LegRight", CubeListBuilder.create().texOffs(13, 7).mirror(false).addBox(-0.5F, -0.8F, -1.0F, 1, 2, 1), PartPose.offsetAndRotation(-0.9F, 2.0F, 1.0F, 0.091106186954104F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("Neck", CubeListBuilder.create().texOffs(14, 0).mirror(false).addBox(-1.0F, -2.0F, -0.6F, 2, 3, 2), PartPose.offsetAndRotation(0.0F, 0.0F, -1.5F, 0.6373942428283291F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("Beak", CubeListBuilder.create().texOffs(14, 5).mirror(false).addBox(-0.5F, 0.0F, -1.0F, 1, 1, 1), PartPose.offset(0.0F, 0.0F, -0.9F));
            partDefinition.addOrReplaceChild("Tail", CubeListBuilder.create().texOffs(0, 13).mirror(false).addBox(-1.5F, 0.0F, 0.0F, 3, 3, 2), PartPose.offsetAndRotation(0.0F, -1.7F, 1.5F, -0.6373942428283291F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(0, 7).mirror(false).addBox(-1.5F, -1.5F, -1.5F, 3, 3, 3), PartPose.offsetAndRotation(0.0F, -1.8F, 0.6F, -0.4553564018453205F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("Body", CubeListBuilder.create().texOffs(0, 0).mirror(false).addBox(-2.0F, -2.0F, -1.5F, 4, 4, 3), PartPose.offsetAndRotation(0.0F, 20.7F, 0.0F, -0.091106186954104F, 0.0F, 0.0F));
