...
public class HotItems {
    ...
    // TREE FRUITS
    public static final RegistryObject<Item> PEACH = ITEMS.register("peach", () -> new Item(new Item.Properties().tab(ItemGroup.TAB_FOOD).food(HotFoods.PEACH)));
    public static final RegistryObject<Item> MANGO = ITEMS.register("mango", () -> new Item(new Item.Properties().tab(ItemGroup.TAB_FOOD).food(HotFoods.MANGO)));
    public static final RegistryObject<Item> POMEGRANATE = ITEMS.register("pomegranate", () -> new Item(new Item.Properties().tab(ItemGroup.TAB_FOOD).food(HotFoods.POMEGRANATE)));
    public static final RegistryObject<Item> FIG = ITEMS.register("fig", () -> new Item(new Item.Properties().tab(ItemGroup.TAB_FOOD).food(HotFoods.FIG)));
    public static final RegistryObject<Item> CITRON = ITEMS.register("citron", () -> new Item(new Item.Properties().tab(ItemGroup.TAB_FOOD).food(HotFoods.CITRON)));
    public static final RegistryObject<Item> POMELO = ITEMS.register("pomelo", () -> new Item(new Item.Properties().tab(ItemGroup.TAB_FOOD).food(HotFoods.POMELO)));
    public static final RegistryObject<Item> MANDARIN = ITEMS.register("mandarin", () -> new Item(new Item.Properties().tab(ItemGroup.TAB_FOOD).food(HotFoods.MANDARIN)));
    public static final RegistryObject<Item> PAPEDA = ITEMS.register("papeda", () -> new Item(new Item.Properties().tab(ItemGroup.TAB_FOOD).food(HotFoods.PAPEDA)));
    public static final RegistryObject<Item> ORANGE = ITEMS.register("orange", () -> new Item(new Item.Properties().tab(ItemGroup.TAB_FOOD).food(HotFoods.ORANGE)));
    public static final RegistryObject<Item> LEMON = ITEMS.register("lemon", () -> new Item(new Item.Properties().tab(ItemGroup.TAB_FOOD).food(HotFoods.LEMON)));
    public static final RegistryObject<Item> GRAPEFRUIT = ITEMS.register("grapefruit", () -> new Item(new Item.Properties().tab(ItemGroup.TAB_FOOD).food(HotFoods.GRAPEFRUIT)));
    public static final RegistryObject<Item> LIME = ITEMS.register("lime", () -> new Item(new Item.Properties().tab(ItemGroup.TAB_FOOD).food(HotFoods.LIME)));
    public static final RegistryObject<Item> YUZU = ITEMS.register("yuzu", () -> new Item(new Item.Properties().tab(ItemGroup.TAB_FOOD).food(HotFoods.YUZU)));
