...
public class HotFeatures {
    public static final ConfiguredFeature<?, ?> CORN = Feature.RANDOM_PATCH.configured(
    ...
    public static final ConfiguredFeature<?, ?> MILLET = Feature.RANDOM_PATCH.configured(
            (new BlockClusterFeatureConfig.Builder(
    ...
    public static final ConfiguredFeature<?, ?> OAT = Feature.RANDOM_PATCH.configured(
            (new BlockClusterFeatureConfig.Builder(
    ...
    public static final ConfiguredFeature<?, ?> GARLIC = Feature.RANDOM_PATCH.configured(
            (new BlockClusterFeatureConfig.Builder(
                    new SimpleBlockStateProvider(HotBlocks.GARLIC_CROP.get().defaultBlockState()),
                    SimpleBlockPlacer.INSTANCE)).tries(64).whitelist(ImmutableSet.of(Blocks.GRASS_BLOCK.getBlock())).noProjection().build()
    ).decorated(Features.Placements.HEIGHTMAP_DOUBLE_SQUARE).count(20);

    public static final ConfiguredFeature<?, ?> BLUEBERRY_BUSH = Feature.RANDOM_PATCH.configured(
            (new BlockClusterFeatureConfig.Builder(
    ...
    public static final ConfiguredFeature<?, ?> PEPPER_BUSH = Feature.RANDOM_PATCH.configured(
            (new BlockClusterFeatureConfig.Builder(
    ...
    public static final ConfiguredFeature<?, ?> STRAWBERRY_BUSH = Feature.RANDOM_PATCH.configured(
            (new BlockClusterFeatureConfig.Builder(
                    new SimpleBlockStateProvider(HotBlocks.STRAWBERRY_BUSH.get().defaultBlockState()),
                    LowLightPlacer.INSTANCE)).tries(64).whitelist(ImmutableSet.of(Blocks.GRASS_BLOCK.getBlock())).noProjection().build()
    ).decorated(Features.Placements.HEIGHTMAP_DOUBLE_SQUARE);

    public static final ConfiguredFeature<?, ?> WILD_GRAPE = Feature.RANDOM_PATCH.configured(
            (new BlockClusterFeatureConfig.Builder(
    ...
    public static final ConfiguredFeature<?, ?> WILD_KIWI = Feature.RANDOM_PATCH.configured(
            (new BlockClusterFeatureConfig.Builder(
    ...
    public static final ConfiguredFeature<?, ?> WILD_TOMATO = Feature.RANDOM_PATCH.configured(
            (new BlockClusterFeatureConfig.Builder(
                    new SimpleBlockStateProvider(HotBlocks.WILD_TOMATO.get().defaultBlockState()),
                    LowLightPlacer.INSTANCE)).tries(64).whitelist(ImmutableSet.of(Blocks.GRASS_BLOCK.getBlock())).noProjection().build()
    ).decorated(Features.Placements.HEIGHTMAP_DOUBLE_SQUARE).count(20);
    public static final ConfiguredFeature<?, ?> WILD_PEA = Feature.RANDOM_PATCH.configured(
            (new BlockClusterFeatureConfig.Builder(
                    new SimpleBlockStateProvider(HotBlocks.WILD_PEA.get().defaultBlockState()),
                    LowLightPlacer.INSTANCE)).tries(64).whitelist(ImmutableSet.of(Blocks.OAK_LOG.getBlock(), Blocks.BIRCH_LOG.getBlock())).noProjection().build()
    ).decorated(Features.Placements.HEIGHTMAP_DOUBLE_SQUARE).count(20);

    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> RED_APPLE = configureFruitTree(Blocks.OAK_LOG, HotBlocks.RED_APPLE_LEAVES.get(), HotBlocks.FRUIT_LEAVES.get(),
            new FancyFoliagePlacer(FeatureSpread.fixed(2), FeatureSpread.fixed(4), 4),
            new FancyTrunkPlacer(3, 11, 0),
            0, 0, 0, OptionalInt.of(4));
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> PEACH = configureFruitTree(Blocks.DARK_OAK_LOG, HotBlocks.PEACH_LEAVES.get(), HotBlocks.FRUIT_LEAVES.get(),
            new BlobFoliagePlacer(FeatureSpread.fixed(2), FeatureSpread.fixed(0), 3),
            new StraightTrunkPlacer(4, 2, 0),
            1, 0, 1, OptionalInt.empty());
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> MANGO = configureFruitTree(Blocks.ACACIA_LOG, HotBlocks.MANGO_LEAVES.get(), HotBlocks.TROPICAL_FRUIT_LEAVES.get(),
            new FancyFoliagePlacer(FeatureSpread.fixed(2), FeatureSpread.fixed(4), 4),
            new FancyTrunkPlacer(8, 2, 6),
            0, 0, 0, OptionalInt.of(4));
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> POMEGRANATE = configureFruitTree(Blocks.DARK_OAK_LOG, HotBlocks.POMEGRANATE_LEAVES.get(), HotBlocks.FRUIT_LEAVES.get(),
            new FancyFoliagePlacer(FeatureSpread.fixed(2), FeatureSpread.fixed(5), 4),
            new FancyTrunkPlacer(3, 2, 0),
            0, 0, 0, OptionalInt.of(4));
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> FIG = configureFruitTree(Blocks.OAK_LOG, HotBlocks.FIG_LEAVES.get(), HotBlocks.FICUS_LEAVES.get(),
            new AcaciaFoliagePlacer(FeatureSpread.fixed(2), FeatureSpread.fixed(1)),
            new StraightTrunkPlacer(3, 2, 0),
            1, 0, 1, OptionalInt.empty());
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> CITRON = configureFruitTree(Blocks.OAK_LOG, HotBlocks.CITRON_LEAVES.get(), HotBlocks.CITRUS_LEAVES.get(),
            new AcaciaFoliagePlacer(FeatureSpread.fixed(2), FeatureSpread.fixed(1)),
            new StraightTrunkPlacer(5, 2, 1),
            0, 0, 0, OptionalInt.of(4));
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> POMELO = configureFruitTree(Blocks.OAK_LOG, HotBlocks.POMELO_LEAVES.get(), HotBlocks.CITRUS_LEAVES.get(),
    ...
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> MANDARIN = configureFruitTree(Blocks.OAK_LOG, HotBlocks.MANDARIN_LEAVES.get(), HotBlocks.CITRUS_LEAVES.get(),
            new AcaciaFoliagePlacer(FeatureSpread.fixed(2), FeatureSpread.fixed(1)),
            new ForkyTrunkPlacer(3, 2, 2),
            1, 0, 2, OptionalInt.empty());
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> PAPEDA = configureFruitTree(Blocks.OAK_LOG, HotBlocks.PAPEDA_LEAVES.get(), HotBlocks.CITRUS_LEAVES.get(),
            new FancyFoliagePlacer(FeatureSpread.fixed(2), FeatureSpread.fixed(4), 4),
            new FancyTrunkPlacer(3, 11, 0),
            0, 0, 0, OptionalInt.of(4));
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> ORANGE = configureFruitTree(Blocks.OAK_LOG, HotBlocks.ORANGE_LEAVES.get(), HotBlocks.CITRUS_LEAVES.get(),
            new FancyFoliagePlacer(FeatureSpread.fixed(2), FeatureSpread.fixed(4), 4),
            new FancyTrunkPlacer(3, 11, 0),
            0, 0, 0, OptionalInt.of(4));
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> LEMON = configureFruitTree(Blocks.OAK_LOG, HotBlocks.LEMON_LEAVES.get(), HotBlocks.CITRUS_LEAVES.get(),
            new AcaciaFoliagePlacer(FeatureSpread.fixed(2), FeatureSpread.fixed(1)),
            new StraightTrunkPlacer(5, 2, 1),
            0, 0, 0, OptionalInt.of(4));
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> GRAPEFRUIT = configureFruitTree(Blocks.OAK_LOG, HotBlocks.GRAPEFRUIT_LEAVES.get(), HotBlocks.CITRUS_LEAVES.get(),
            new JungleFoliagePlacer(FeatureSpread.fixed(2), FeatureSpread.fixed(0), 2),
            new StraightTrunkPlacer(5, 1, 9),
            1, 1, 2, OptionalInt.empty());
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> LIME = configureFruitTree(Blocks.OAK_LOG, HotBlocks.LIME_LEAVES.get(), HotBlocks.CITRUS_LEAVES.get(),
            new FancyFoliagePlacer(FeatureSpread.fixed(2), FeatureSpread.fixed(4), 4),
            new FancyTrunkPlacer(3, 11, 0),
            0, 0, 0, OptionalInt.of(4));
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> YUZU = configureFruitTree(Blocks.OAK_LOG, HotBlocks.YUZU_LEAVES.get(), HotBlocks.CITRUS_LEAVES.get(),
            new AcaciaFoliagePlacer(FeatureSpread.fixed(2), FeatureSpread.fixed(1)),
            new StraightTrunkPlacer(5, 2, 1),
            0, 0, 0, OptionalInt.of(4));
