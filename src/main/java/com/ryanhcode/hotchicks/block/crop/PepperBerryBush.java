...
public class PepperBerryBush extends BushBlock implements IGrowable {
    ...
    public PepperBerryBush(Properties properties, RegistryObject<Item> item) {
        super(properties);
        this.registerDefaultState(this.stateDefinition.any().setValue(AGE, Integer.valueOf(0)).setValue(VARIANT, PepperType.getRandom()));
        this.item = item;
    }
    ...
    public ActionResultType use(BlockState state, World worldIn, BlockPos pos, PlayerEntity player, Hand handIn, BlockRayTraceResult hit) {
        ...
        if (!flag && player.getItemInHand(handIn).getItem() == Items.BONE_MEAL) {
            ...
            worldIn.setBlock(pos, state.setValue(AGE, Integer.valueOf(2)).setValue(VARIANT, PepperType.getRandom()), 2);
    ...
    public void performBonemeal(ServerWorld worldIn, Random rand, BlockPos pos, BlockState state) {
        ...
        worldIn.setBlock(pos, state.setValue(AGE, Integer.valueOf(i)).setValue(VARIANT, PepperType.getRandom()), 2);
    }
}
