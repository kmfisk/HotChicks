package com.ryanhcode.hotchicks.client.renderer.entity.model;
...
public class HotChickenModel extends SegmentedModel<HotChickenEntity> {
    ...
    @Override
    public void setupAnim(HotChickenEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        float speed = 3.0f;
        float degree = 1.4f;
