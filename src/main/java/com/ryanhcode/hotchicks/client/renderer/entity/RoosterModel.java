...
public class RoosterModel<T extends LivingEntity> extends EntityModel {
    ...
    public RoosterModel() {
        ...
        this.Wattle.setRotationPoint(0.0F, 1.2F, -1.0F);
        ...
        this.NeckFeathersRight.setRotationPoint(-0.4F, -4.0F, 3.0F);
        ...
        this.Comb.setRotationPoint(0.0F, -2.6F, -2.4F);
        ...
        this.TailFeathers.setRotationPoint(0.0F, 0.0F, 2.0F);
        ...
        this.SpurRight.setRotationPoint(0.0F, 0.0F, 0.0F);
        ...
        this.NeckFeathersLeft.setRotationPoint(0.4F, -4.0F, 3.0F);
        ...
        this.SpurLeft.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.SpurLeft.addBox(0.0F, 0.0F, 0.0F, 0, 1, 1, 0.0F);
        this.TailFeathers2 = new ModelRenderer(this, 10, 23);
        this.TailFeathers2.setRotationPoint(0.0F, 0.0F, 4.0F);
