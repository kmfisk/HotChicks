...
public class BlockRegistry {
    ...
    public static final RegistryObject<Block> NEST = BLOCKS.register("nest", () -> new StickNestBlock(AbstractBlock.Properties.of(Material.GRASS).strength(0.5F).sound(SoundType.GRASS).noOcclusion()));
    ...
    public static final RegistryObject<Block> TRELLIS_BLOCK = BLOCKS.register("trellis", () -> new TrellisBlock(AbstractBlock.Properties.of(Material.WOOD).strength(0.8F).sound(SoundType.WOOD).noOcclusion()));
